...
alias kanataon="sudo launchctl start org.nixos.kanata"
alias kanataoff="sudo launchctl stop org.nixos.kanata"
alias kanatacheck="kanata --cfg ~/.dotfiles/kmonad/kanata.kbd --check"
