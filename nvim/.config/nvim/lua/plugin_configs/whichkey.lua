return {
  ...
  config = function()
    ...
    wk.add({
      ...
      { "<leader>tg",  "<cmd>FloatermNew --autoclose=2 --name=lazygit lazygit --use-config-file=\"$HOME/.dotfiles/lazygit/.config/lazygit/config.yml\"<cr>", desc = "lazygit" },
      ...
      { "<leader>sw",  "<cmd>SessionSave<cr>",                                                                                                               desc = "Save" },
